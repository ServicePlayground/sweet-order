 ...
 * 공통 필드를 포함합니다.
 */
export class ChatRoomBaseResponseDto {
  @ApiProperty({
    description: "채팅방 ID",
 ...
 * 채팅방 응답 DTO (사용자용)
 */
export class ChatRoomResponseDto extends ChatRoomBaseResponseDto {
  @ApiProperty({
    description: "스토어 정보",
 ...
 * 채팅방 응답 DTO (판매자용)
 */
export class ChatRoomForSellerResponseDto extends ChatRoomBaseResponseDto {
  @ApiProperty({
    description: "사용자 정보",
