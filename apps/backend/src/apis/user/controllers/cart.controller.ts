...
export class UserCartController {
  ...
  @SwaggerResponse(201, SWAGGER_RESPONSE_EXAMPLES.CART_ITEM_RESPONSE)
  ...
  async addCartItem(
    ...
    return await this.cartService.addCartItem(req.user.sub, addCartItemDto);
  }
  ...
  @SwaggerResponse(200, SWAGGER_RESPONSE_EXAMPLES.CART_ITEM_RESPONSE)
  ...
  async updateCartItem(
    ...
    return await this.cartService.updateCartItem(req.user.sub, cartItemId, updateCartItemDto);
  }
