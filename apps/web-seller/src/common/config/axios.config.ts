...
// seller API 클라이언트
export const apiClient = axios.create({ ...axiosConfig, baseURL: `${API_BASE_URL}/v1/seller` });

// user - auth API (logout, me) 클라이언트
export const authClient = axios.create({ ...axiosConfig, baseURL: `${API_BASE_URL}/v1/user` });
